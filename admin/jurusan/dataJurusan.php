...
<div class="heading">
      <h1><img src="../image/product.png" alt="" /> Data Jurusan</h1>
					...
					<table id="dt-example" cellpadding="0" cellspacing="0" border="0" class="table-dt table-striped-dt table-bordered-dt dataTable" >
						...
						?>
							<tr class="gradeX">
								...
								<td class="center"><a href="admin.php?page=jurusan/editJurusan&id=<?php echo $data[0]?>">Edit </a>|| <a href="jurusan/delete.php?id=<?php echo $data[0]?>" onclick="return confirm('yakin delete ?')">Delete</a></td>
