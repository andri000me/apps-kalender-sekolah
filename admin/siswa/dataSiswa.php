					...
					<table id="dt-example" cellpadding="0" cellspacing="0" border="0" class="table-dt table-striped-dt table-bordered-dt dataTable" >
						...
						?>
							<tr class="gradeX">
								...
								<td class="center"><a href="admin.php?page=siswa/editSiswa&id=<?php echo $data[0]?>">Edit </a> ||<a href="siswa/deleteData.php?id=<?php echo $data[0]?>" onclick="return confirm('yakin delete ?')">Delete</a></td>
