			...
			<div class="box">
            	<div class="box-content nopadding">
					<table id="dt-example" cellpadding="0" cellspacing="0" border="0" class="table-dt table-striped-dt table-bordered-dt dataTable" >
						...
						include "../config/koneksi.php";
						$q=mysql_query("select  tugas.*,jawaban.id_siswa,siswa.nama_siswa from tugas join jawaban on tugas.kd_tugas=jawaban.kd_tugas join siswa on jawaban.id_siswa=siswa.nis  ");
