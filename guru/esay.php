      ...
      <thead>
            <tr>
              <td height="29" class="left">Soal Esay</td>
               <td class="left">Jawaban Esay</td>
          
          </tr>
        </thead>
        <tbody>
            <tr>
              <td class="left"><input type="text" name="soal_0" style='width:100%'  ></td>
        ...
        <input type="text" name="jml"  id="jml"  value='1'>
