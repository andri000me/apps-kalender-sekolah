...
$cek=mysql_query("select max(id_tugas) as id from tugas");
$y=mysql_fetch_array($cek);
$t=$y['id']+1;
if($jenis==1){
$fileName = $_FILES['file']['name'];
$q=mysql_query("insert into tugas(id_jdwl,deskripsi,tgl_mulai,tgl_akhir,keterangan,jenis,file)values('$kode','$desc','$awal','$akhir','$keterangan','$jenis','$fileName')")or die(mysql_error());
...
for ($x=0;$x<=$jml-1;$x++) {
			...
			$sale = mysql_query("INSERT INTO tugas_detail(id_jdwl,id_tugas,jwbn) values('$kode','$t','$jawaban')")or die(mysql_error());
...
$q=mysql_query("insert into tugas(id_jdwl,deskripsi,tgl_mulai,tgl_akhir,keterangan,jenis)values('$kode','$desc','$awal','$akhir','$keterangan','$jenis')")or die(mysql_error());
...
for ($x=0;$x<=$jml-1;$x++) {
			...
			$tmpJawaban = "jawaban_$x";
			$jawaban =$_POST[$tmpJawaban];
			$sale = mysql_query("INSERT INTO tugas_detail(id_jdwl,tugas,id_tugas,jwbn) values('$kode','$soal','$t','$jawaban')")or die(mysql_error());
...
<div class="heading">
      ...
      <h1><img src="../image/product.png" alt="" /> Add Nilai</h1>
